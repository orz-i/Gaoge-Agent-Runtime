...
```bash
node scripts/release-tags.mjs --version 0.1.0-beta.9
node scripts/release-tags.mjs --version 0.1.0-beta.9 --create
git push --atomic origin \
  v0.1.0-beta.9 \
  go/agent-runtime/v0.1.0-beta.9 \
  go/agent-runtime-harness/v0.1.0-beta.9 \
  go/agent-runtime-harness-postgres/v0.1.0-beta.9 \
  go/agent-runtime-mcp/v0.1.0-beta.9 \
  go/agent-runtime-a2a/v0.1.0-beta.9 \
  go/agent-runtime-postgres/v0.1.0-beta.9 \
  go/agent-runtime-redis/v0.1.0-beta.9 \
  go/agent-runtime-http/v0.1.0-beta.9
```
...
```bash
gh workflow run release.yml --ref main -f release_tag=v0.1.0-beta.9
```
