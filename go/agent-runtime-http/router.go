...
func (m *Module) RegisterRoutes(auth *gin.RouterGroup) {
	...
	routes.POST("/text-runs", m.Handler.StartTextRun)
	routes.POST("/plan-runs", m.Handler.StartPlanRun)
	routes.POST("/workflow-runs", m.Handler.StartWorkflow)
	routes.POST("/team-runs", m.Handler.StartAgentTeam)
	routes.GET("/runs", m.Handler.ListRuns)
	routes.GET("/runs/:run_id", m.Handler.GetTextRun)
	routes.GET("/runs/:run_id/provenance", m.Handler.GetRunExecutionProvenance)
	routes.GET("/runs/:run_id/result", m.Handler.GetRunResult)
	routes.POST("/runs/:run_id/cancel", m.Handler.CancelRun)
	routes.POST("/plan-runs/:run_id/approval", m.Handler.ResolvePlanApproval)
