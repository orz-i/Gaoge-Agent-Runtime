...
type contextCheckpointRecord struct {
	...
	ScopeID                string `gorm:"size:128;not null;index:idx_harness_context_checkpoint_scope,priority:1;index:idx_harness_context_checkpoint_reuse,priority:1;index:idx_harness_context_checkpoint_path,priority:1"`
	...
	StaticFingerprint      string `gorm:"size:64;not null;index:idx_harness_context_checkpoint_reuse,priority:2;index:idx_harness_context_checkpoint_path,priority:2"`
	CoveredThroughSourceID string `gorm:"size:128;not null;index:idx_harness_context_checkpoint_reuse,priority:4"`
	CoveredPathHash        string `gorm:"size:64;not null;index:idx_harness_context_checkpoint_path,priority:4"`
	SourceAligned          bool   `gorm:"not null;index:idx_harness_context_checkpoint_reuse,priority:3;index:idx_harness_context_checkpoint_path,priority:3"`
	PayloadJSON            string `gorm:"type:text;not null"`
}
