...
func openConversationRepositoryTestDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(&model.RunRecord{}, &model.EventRecord{}, &model.RunStep{}, &model.RuntimePlanRecord{}, &model.RunInteraction{}, &model.RunCheckpoint{}, &model.RuntimeOutputIdentityRecord{}, &model.RuntimeOutputRefRecord{}, &model.RuntimeWorkbenchProjectionRecord{}, &model.RuntimePhaseProjectionRecord{}, &model.EvidenceSelection{}, &model.RunQueueItemRecord{}, &model.ContextRecord{}); err != nil {
